...
bayesian_estimation_gamma <-  function(time, time_trunc,  beta_r = NULL, mu_T_r = NULL, compiled_model = NULL, simulation = TRUE, seed = NULL)  {
  ...
  if (is.null(compiled_model)) {
    ...
    ajuste <- sampling(modelo.compilado.gamma, data = datos.stan,

...
run_simulation_parallel_cluster <- function(m, k, param, time_trunc, SEED = NULL) {
  ...
  clusterExport(cl, varlist = c(
    "gen_failures_ARA", "frequentist_estimation", "bayesian_estimation_gamma",
    "Lambda_ARA", "lambda_ARA", "log_like_ARA", "modelo.stan.gamma", 
  ...
  single_run <- function(i) {
    ...
    # Generar datos
    time <- tryCatch({
      gen_failures_ARA(k, c(beta_r, mu_T_r, theta_r), time_trunc)
    }, error = function(e) {

...
bayesian_estimation_corr <- function(time, time_trunc,  beta_r = NULL, mu_T_r = NULL, theta_r = NULL,
                                     tau, compiled_model_corr = NULL, simulation = TRUE, seed = NULL) {
  ...
  ajuste <- sampling(compiled_model_corr, data = datos.stan,
                     ...
                     control = list(adapt_delta = 0.9, max_treedepth = 15), refresh = 100)
